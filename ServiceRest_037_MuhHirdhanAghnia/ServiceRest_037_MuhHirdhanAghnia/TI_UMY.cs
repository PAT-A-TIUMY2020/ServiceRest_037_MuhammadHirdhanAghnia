...
namespace ServiceRest_037_MuhHirdhanAghnia
{
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-5QOEH7MN; Initial Catalog=\"TI UMY\"; Persist Security Info=True; User ID=sa; Password=iDhanzaghnia99");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-5QOEH7MN; Initial Catalog=\"TI UMY\"; Persist Security Info=True; User ID=sa; Password=iDhanzaghnia99");
